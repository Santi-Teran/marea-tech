  ...
  return (
    <div className="flex justify-center items-center mx-20 my-10 gap-40 mt-28">
      <div className="w-1/2 flex flex-col gap-10">
        ...
        <Link href={'/servicios'} className={`${nunito.className} text-xl font-black gradient w-fit py-4 px-8 rounded-xl hover:scale-125 transition-transform`}>Conoce nuestros servicios</Link>
      </div>
      <div className="w-1/2">
        <Image src={web} alt=""/>
      </div>
